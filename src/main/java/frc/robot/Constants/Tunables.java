...
public class Tunables {
    ...
    public static final class DriveBaseTunables {
         ...
         * <p> radians/sec
         */
        public static final double TURN_SPEED = -6.0; // 3 rad/s
    ...
    public static final class SwerveModuleTunables {
        ...
        public static final SparkBaseConfig DRIVE_MOTOR_CONFIG =
                new SparkMaxConfig().smartCurrentLimit(36).inverted(true).idleMode(SparkBaseConfig.IdleMode.kBrake);
    ...
    public static final class IntakeTunables {
        ...
        public static final Time DEPLOY_ATTEMPT_TIME = Seconds.of(2.1);
