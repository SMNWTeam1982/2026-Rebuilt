...
public class RobotCommands {
    ...
    public static Command tryUnjam(
        ...
        return Commands.sequence(
            Commands.parallel(
                ...
                kicker.setReverse(),
                intake.setReverse()),
            shooter.runPIDs().withTimeout(Tunables.UNJAM_ATTEMPT_TIME), // give subsystems some time to try and unjam
            Commands.parallel( // if the subsystems are still jammed after then disable their jammed components
                shooter.turnOffJammedChannels(),
                intake.turnOffJammedIntake(),
                kicker.setIdle()
            )
