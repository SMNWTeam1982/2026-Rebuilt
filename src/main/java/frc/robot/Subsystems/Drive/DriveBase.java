...
public final class DriveBase {
  public final SwerveModule frontLeft =
      new SwerveModule(
          DriveIDs.FRONT_LEFT_DRIVE, DriveIDs.FRONT_LEFT_TURN, DriveIDs.FRONT_LEFT_ENCODER);
  public final SwerveModule frontRight =
      new SwerveModule(
          DriveIDs.FRONT_RIGHT_DRIVE, DriveIDs.FRONT_RIGHT_TURN, DriveIDs.FRONT_RIGHT_ENCODER);
  public final SwerveModule backLeft =
      new SwerveModule(
          DriveIDs.BACK_LEFT_DRIVE, DriveIDs.BACK_LEFT_TURN, DriveIDs.BACK_LEFT_ENCODER);
  public final SwerveModule backRight =
      new SwerveModule(
          DriveIDs.BACK_RIGHT_DRIVE, DriveIDs.BACK_RIGHT_TURN, DriveIDs.BACK_RIGHT_ENCODER);
  ...
  public final SwerveDrivePoseEstimator swervePoseEstimator =
      new SwerveDrivePoseEstimator(
          driveKinematics, gyro.getRotation2d(), getModulePositions(), new Pose2d());
  ...
  public void setModulesFromRobotRelativeSpeeds(ChassisSpeeds speeds) {
    ...
    SwerveDriveKinematics.desaturateWheelSpeeds(
        moduleStates, DriveBaseTunables.ARTIFICIAL_MAX_SPEED);
