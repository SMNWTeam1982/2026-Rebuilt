...
public class IntakeSubsystem extends SubsystemBase {
    ...
    private final PIDController pivotController = new PIDController(
        IntakeTunables.PIVOT_P,
        IntakeTunables.PIVOT_I,
        IntakeTunables.PIVOT_D
    );

    /** for gravity compensation */
    public final ArmFeedforward pivotFeedforward = new ArmFeedforward(
        IntakeTunables.PIVOT_S,
        IntakeTunables.PIVOT_G,
        IntakeTunables.PIVOT_V
    );
